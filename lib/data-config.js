...
const BLOCK_CONFIG = {
  client: {
    ...
    framework: {
      ...
      properties: {
        frameworkVersion: { data: CLIENT_FRAMEWORKS,  required: false, key: 'clientFwVersion', step: 0 },
    ...
    integratedBackend: { data: null, required: false, key: 'useIntegratedBackend', step: 1 },
  },
  backend: {
    isActive: false,
    framework: {
      ...
      properties: {
        frameworkVersion: { data: BACKEND_FRAMEWORKS, required: false, key: 'backendFwVersion', step: 0 },
